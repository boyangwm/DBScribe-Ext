DROP SCHEMA IF EXISTS `swtbus` ;
CREATE SCHEMA IF NOT EXISTS `swtbus`;
USE `swtbus` ;
...
CREATE TABLE PTVozniRedi (
        ...
        Firma INT NOT NULL,
        Sifra VARCHAR(50),
        OznakaLinije VARCHAR(50),
        PrivitakDozvole VARCHAR(50),
