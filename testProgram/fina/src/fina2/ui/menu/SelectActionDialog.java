/*
 * SelectActionDialog.java
 *
 * Created on November 2, 2001, 12:22 PM
 */
 ...
 */
public class SelectActionDialog extends javax.swing.JDialog {
    ...
    /** Creates new form SelectActionDialog */
    public SelectActionDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initTable() {
        ...
        for (Iterator iter = ui.getAllActions().keySet().iterator(); iter
                .hasNext();) {
            String key = (String) iter.next();
            AbstractAction action = ui.getAllAction(key);
            String name = (String) action.getValue(AbstractAction.NAME);
            if (name == null)
                name = "NULL";
            TableRowImpl row = new TableRowImpl(key, 1);
            row.setValue(0, name);
            rows.add(row);
        }
        Vector colNames = new Vector();
        colNames.add(ui.getString("fina2.actions.action"));
