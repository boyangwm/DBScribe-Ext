/*
 * SelectBankDialog.java
 *
 * Created on November 6, 2001, 5:13 PM
 */
 ...
 */
public class SelectBankDialog extends javax.swing.JDialog {
    ...
    /** Creates new form SelectBankDialog */
    public SelectBankDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initTable() {
        try {
            ...
            table.initTable(colNames, session.getBanksRows(
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setTitle(ui.getString("fina2.bank.banks"));
