/*
 * ManagingBodySelectDialog.java
 *
 * Created on April 5, 2002, 5:34 AM
 */
 ...
 * @author vasop
 */
public class ManagingBodySelectDialog extends javax.swing.JDialog {
	...
	/** Creates new form ManagingBodySelectDialog */
	public ManagingBodySelectDialog(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
	...
	private void initTable() {
		try {
			...
			ManagingBodySessionHome home = (ManagingBodySessionHome) PortableRemoteObject
					.narrow(ref, ManagingBodySessionHome.class);
			...
			table.initTable(
					colNames,
					session.getManagingBodyRows(main.getUserHandle(),
	...
	private void initComponents() {// GEN-BEGIN:initComponents
		...
		setTitle(ui.getString("fina2.bank.magingBodySelectDialog"));
